    ...
    return Container(
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          title: MyText(title: "${tr("terms")}",size: 16,color: MyColors.white,),
          leading: InkWell(
              ...
              child: Column(
                children: <Widget>[
                  Container(
                    ...
                    child: Image(image: AssetImage("images/scorelogo.png"),fit: BoxFit.contain,width: 200,height: 80,),
                  ),
