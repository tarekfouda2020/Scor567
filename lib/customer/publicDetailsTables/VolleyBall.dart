...
class VolleyBallPublicDetailsTables extends StatefulWidget {
  var arrange = [];
  var type;
  GlobalKey<ScaffoldState> _scafold;

  VolleyBallPublicDetailsTables(this._scafold, this.type, this.arrange);
  @override
  _VolleyBallPublicDetailsTablesState createState() =>
      _VolleyBallPublicDetailsTablesState();
}

class _VolleyBallPublicDetailsTablesState
    extends State<VolleyBallPublicDetailsTables> {
  @override
