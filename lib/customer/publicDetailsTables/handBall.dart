...
class HandBallPublicDetailsTables extends StatefulWidget {
  var arrange = [];
  var type;
  GlobalKey<ScaffoldState> _scafold;

  HandBallPublicDetailsTables(this._scafold, this.type, this.arrange);
  @override
  _HandBallPublicDetailsTablesState createState() =>
      _HandBallPublicDetailsTablesState();
}

class _HandBallPublicDetailsTablesState
    extends State<HandBallPublicDetailsTables> {
  @override
