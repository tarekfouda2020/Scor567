...
class FirstDays extends StatefulWidget {
...
class _classState extends State<FirstDays> {
  ...
  Future _getHome(day, month) async {
    ...
    var body = {
      ...
      "token": "$_token",
      "lang": "$_lang",
      "mytime": DateTime(_year, int.parse(month), int.parse(day))
          .timeZoneOffset
          .inHours
          .toString(),
    };
  ...
  _setDate() async {
    ...
    for (int i = 2; i <= 7; i++) {
      var _nextYear = DateFormat('yyyy', "en")
          .format(DateTime.now().add(Duration(days: i)));
      var _prevNum =
          DateFormat('dd', "en").format(today.add(Duration(days: i)));
      var _prevName =
          DateFormat('EEEE', "$_lang").format(today.add(Duration(days: i)));
      var _prevMonth =
          DateFormat('MM', "en").format(today.add(Duration(days: i)));
  ...
  _setSelectedDay(index) {
    ...
    model.changenext(false);
    print(_days);
    setState(() {
      _year = int.parse(_days[index]["year"]);
    });
    _getHome(_days[index]["num"], _days[index]["prevMonth"]);
    setState(() {});
  }
  ...
  Widget build(BuildContext context) {
    ...
    final model = Provider.of<DaysModel>(context);
    final favModel = Provider.of<AddFavouriteModel>(context);
                                                                ...
                                                                Row(
                                                                  ...
                                                                  children: <
                                                                    ...
                                                                    Container(
                                                                      ...
                                                                      child:
                                                                          MyText(
                                                                        title: _champions[index]["AppHomeViewModelMatch"][i]["HomeTeamGoals"]
                                                                            .toString(),
                                                                        size:
                                                                            14,
                                                                        color: MyColors
                                                                    ...
                                                                    Container(
                                                                      ...
                                                                      child:
                                                                          MyText(
                                                                        title: _champions[index]["AppHomeViewModelMatch"][i]["AwayTeamGoals"]
                                                                            .toString(),
                                                                        size:
                                                                            14,
                                                                        color: MyColors
                      ...
                      children: List.generate(_days.length, (index) {
                        return InkWell(
                          onTap: () {
                            _setSelectedDay(index);
                            _getHome(
                                _days[index]["num"], _days[index]["prevMonth"]);
                            setState(() {
                              _dayIndex = "${_days[index]["num"]}";
                              _monthIndex = "${_days[index]["prevMonth"]}";
                            });
                          },
                          child: Container(
