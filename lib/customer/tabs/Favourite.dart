...
import 'package:score/customer/tabs/favouriteTabs/FirstDays.dart';
import 'package:score/customer/tabs/favouriteTabs/LastDays.dart';
import 'package:score/customer/tabs/favouriteTabs/NextDay.dart';
import 'package:score/customer/tabs/favouriteTabs/PreviousDay.dart';
import 'package:score/customer/tabs/favouriteTabs/Today.dart';
...
class _classState extends State<Favourite> {
  var _prevName = "";
  var _prevNum = "";
  var _nextName = "";
  var _nextNum = "";
  ...
  _setDate() async {
    ...
    _prevName =
        DateFormat('EEEE', "$_lang").format(today.subtract(Duration(days: 1)));
    _nextName =
        DateFormat('EEEE', "$_lang").format(today.add(Duration(days: 1)));
        ...
        appBar: PreferredSize(
          ...
          child: Column(
            children: <Widget>[
              ...
              //       onTap: () {
              //         Navigator.push(
              //             context, SlideRightRoute(page: LiveMatches(true)));
              //       },
              //       child: Container(
              //         margin: EdgeInsets.only(right: 10.0, left: 10.0),
              //         child: Icon(
