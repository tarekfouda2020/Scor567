...
class TennisScheduleTable extends StatefulWidget {
  ...
  TennisScheduleTable(this._scafold, this.arrangedTeams,
      this.lastIndex, this.upIndex, this.identifiers);
  @override
  _TennisScheduleTableState createState() =>
      _TennisScheduleTableState();
}

class _TennisScheduleTableState extends State<TennisScheduleTable> {
  var down = 0;
  setNum() {
    setState(() {
