...
class BasketBallScheduleTable extends StatefulWidget {
  ...
  BasketBallScheduleTable(this._scafold, this.arrangedTeams,
      this.lastIndex, this.upIndex, this.identifiers);
  @override
  _BasketBallScheduleTableState createState() =>
      _BasketBallScheduleTableState();
}

class _BasketBallScheduleTableState extends State<BasketBallScheduleTable> {
  var down = 0;
  setNum() {
    setState(() {
                ...
                TableRow(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: MyText(
                          title:
                          "${widget.arrangedTeams[index]["Win"] ?? "0"}",
                          size: 11,
                          color: Colors.black,
                        ),
                        alignment: Alignment.center,
